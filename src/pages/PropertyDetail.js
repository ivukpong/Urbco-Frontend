            ...
            <div className="container">
                ...
                <div className="col-lg-9 mb-2">
                  <div className="view">
                    {details.images.length > 0 ? (
                      <img
                        src={details.images[currentImage].url}
                        alt="Property"
                      />
                    ) : (
              ...
              <div className="row mt-3">
                <div className="col-lg-8">
                    ...
                    <div className="features">
                      ...
                      <div className="basic-details">
                        <div className="bs">
                          <div className="list">
                            <p>Units:</p>
                            <strong>{details.total_units}</strong>
                          </div>

                          <div className="list">
                            <p>SQM:</p>
                            <strong>{details.areaSqm}</strong>
                          </div>
                        ...
                        <div className="row mt-3">
                          <div className="col-lg-3 col-md-4 col-sm-6 col-6 mb-3">
                            <div className="basic-2">
                              <p>Investors</p>
                              <h1>{details.investors_count}</h1>
                            </div>
                          </div>
                          <div className="col-lg-3 col-md-4 col-sm-6 col-6 mb-3">
                            <div className="basic-2">
                              <p>Property Value</p>
                              <h1>₦{roundPrice(details.total_price)}</h1>
                            </div>
                          </div>
                          <div className="col-lg-3 col-6 mb-3">
                            <div className="basic-2">
                              ...
                              <h1>
                                ₦{roundPrice(details.investment_available)}
                              </h1>
                            </div>
                          </div>
                          <div className="col-lg-3 col-6 mb-3">
                            <div className="basic-2">
                              <p>Percentage Sold</p>
                              <h1>{getPercentLeft()}%</h1>
                            </div>
                          </div>
                          <div className="col-lg-3 col-6 mb-3">
                            <div className="basic-2">
                              <p>No of Units</p>
                              <h1>{details.total_units}</h1>
                            </div>
                          </div>
                          <div className="col-lg-3 col-6 mb-3">
                            <div className="basic-2">
                              <p>Total Fractions</p>
                              <h1>{details.total_fractions}</h1>
                            </div>
                          </div>
                          <div className="col-lg-3 col-6 mb-3">
                            <div className="basic-2">
                              <p>Fractions Taken</p>
                              <h1>{roundPrice(details.fractions_taken)}</h1>
                            </div>
                          </div>
                          <div className="col-lg-3 col-6 mb-3">
                            <div className="basic-2">
                              <p>Cost Per Fraction</p>
                              <h1>₦{roundPrice(details.cost_per_fraction)}</h1>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="box">
                    <div className="desc">
                      <h4 className="title-p">Project Description</h4>
                      <div
                      ...
                      <div className="main-features row justify-content-center">
                        {details.features.map((f) => (
                          ...
                          >
                            <div className="keys">
                              {f.image ? (
                                <img src={f.image} alt={f.name || "feature"} />
                              ) : (
                                <span>
                                  <FaLandmark />
                                </span>
                              )}
                              <p>{f.feature && f.feature.name}</p>
                            </div>
                          </div>
                        ))}
                      </div>
                      <div className="info">
                        <p>
                          Investment value All-in (No additional charges or
                          payments)
                        </p>
                        <p>Rental rates inclusive of Power & Services.</p>
                      </div>
                    </div>
                  </div>
                  <div className="box">
                    ...
                    <div className="row mt-3">
                      <div className="col-lg-4 col-md-6 mb-3">
                        <div className="basic-2 small">
                          <p>Value per unit</p>
                          <h1>₦{numberWithCommas(details.cost_per_unit)}</h1>
                        </div>
                      </div>
                      <div className="col-lg-4 col-md-6 mb-3">
                        <div className="basic-2 small">
                          ...
                          <h1>
                            ₦{numberWithCommas(details.cost_per_fraction)}
                          </h1>
                        </div>
                      </div>
                      <div className="col-lg-4 col-md-6 mb-3">
                        <div className="basic-2 small">
                          <p>
                            ...
                            <Tooltip
                              ...
                              isOpen={opbpTip}
                              target="opbp"
                              toggle={() => setOpbpTip(!opbpTip)}
                            >
                              Explanation of Offline Purchase Bullet Payment
                            </Tooltip>
                          </p>
                          <h1>{details.opbp.discount}%</h1>
                        </div>
                      </div>
                        ...
                        <div className="basic-2 small">
                          <p>
                            ...
                            <Tooltip
                              ...
                              isOpen={optpTip}
                              target="optp"
                              toggle={() => setOptpTip(!optpTip)}
                            >
                              Explanation of Offline Purchase Tranche Payment
                            </Tooltip>
                          </p>
                          <h1>{details.optp.discount}%</h1>
                        </div>
                      </div>
                      <div className="col-lg-6 mb-3">
                        <div className="basic-2 small">
                          <p>
                            ...
                            <Tooltip
                              ...
                              isOpen={cspTip}
                              target="csp"
                              toggle={() => setCspTip(!cspTip)}
                            >
                              Explanation of Construction Stage Purchase
                            </Tooltip>
                          </p>
                          <h1>{details.csp.discount}%</h1>
                        </div>
                      </div>
                      <div className="col-lg-6 mb-3">
                        <div className="basic-2 small">
                          <p>
                            Off-plan Tranche Payment Stages{" "}
                            <button className="tool-tip">
                              <span id="optps">
                                <BsFillInfoCircleFill size={20} />
                              </span>
                          ...
                          <h1>
                            {details.optp.stages}({listPercentStages()})
                          </h1>
                        </div>
                      </div>
                      <div className="col-lg-6 mb-3">
                        <div className="basic-2 small">
                          <p>
                            ...
                            <Tooltip
                              ...
                              toggle={() => setFull(!full)}
                            >
                              Explanation of Off-plan Payment Secured
                            </Tooltip>
                          </p>
                          <h1>100%</h1>
                        </div>
                    ...
                    <div className="info">
                      <p>Construction stage payment ends at roofing</p>
                      <p>Off-plan Payment secured to completion of roofing</p>
                    </div>
                  </div>
                  <div className="box">
                    ...
                    <div className="row mt-3">
                      <div className="col-lg-4 col-md-6 mb-3">
                        <div className="basic-2 small">
                          <p>Rent per Quarter (projected)</p>
                          <h1>
                            ₦{numberWithCommas(details.rentals.rent_per_quater)}
                          </h1>
                        </div>
                      </div>
                      <div className="col-lg-4 col-md-6 mb-3">
                      ...
                      <div className="col-lg-4 col-md-6 mb-3">
                        <div className="basic-2 small">
                          <p>Rental Income Frequency</p>
                          <h1>{details.rentals.rent_frequency}</h1>
                        </div>
                      </div>
                      <div className="col-lg-4 col-md-6 mb-3">
                        <div className="basic-2 small">
                          <p>Annual Rental Yield (projected)</p>
                          <h1>{details.rentals.annual_yield_percent}%</h1>
                        </div>
                      </div>
                      <div className="col-lg-4 col-md-6 mb-3">
                        <div className="basic-2 small">
                          <p>Rental Yield Assumption</p>
                          <h1>{details.rentals.yield_assumption_percent}%</h1>
                        </div>
                      </div>
                      <div className="col-lg-4 col-md-6 mb-3">
                        <div className="basic-2 small">
                          <p>Rental Income Guarantee</p>
                          <h1>Yes</h1>
                        </div>
                      </div>
                    </div>
                    <div className="row justify-content-center">
                      <div className="col-lg-6 mb-3">
                        <div className="basic-2 small">
                          ...
                          <h1>
                            {dateFormat(
                              details.rentals.first_dividend_date,
                              "mmmm yyyy",
                            )}
                          </h1>
                        </div>
                    ...
                    <div className="row justify-content-center">
                      <div className="col-lg-6 mb-3">
                        <div className="basic-2 small">
                          <p>Timeline to Rental Income Start</p>
                          <h1>Upon Construction Completion</h1>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="box">
                    <h4 className="title-p">Investment Returns</h4>
                    <div className="row mt-5">
                      <div className="col-lg-12 mb-3">
                        <div className="basic-2 small">
                          <p>Investment Return Sources</p>
                          <h1>Rental Income & Capital Appreciation</h1>
                        </div>
                      </div>

                      <div className="col-lg-12 mb-3">
                        <div className="basic-2 small">
                          <p>Rental Yield - Annual (projected)</p>
                          <h1>{details.rentals.annual_yield_percent}%</h1>
                        </div>
                      </div>
                      <div className="col-lg-12 mb-3">
                        <div className="basic-2 small">
                          <p>Capital Appreciation - Annual (projected)</p>
                          <h1>{details.capital_appreciation_percent}%</h1>
                        </div>
                      </div>
                      <div className="col-lg-12 mb-3">
                        <div className="basic-2 small">
                          <p>Investment Returns - Annual (projected)</p>
                          <h1>
                            {details.rentals.annual_yield_percent +
                  ...
                  <div className="calculator-box">
                    ...
                    <div className="c-form row">
                      <div className="col-lg-6">
                        <label>
                          ...
                          <span>({details.total_fractions} Available)</span>
                        </label>
                      </div>
                      <div className="col-lg-6">
                        <input
                          type="number"
                          max={details.total_fractions}
                          value={noOfFractions}
                          onChange={(e) => setNoOfFractions(e.target.value)}
                        />
                      </div>
                      <div className="col-lg-6">
                        <label>Purchase Payment Plan Option</label>
                      </div>
                      <div className="col-lg-6">
                        <select
                          value={purchasePlan}
                    ...
                    <p>
                      This calculator displays a range of projected investment
                      outcomes based on the inputs you have provided. The actual
                      investment outcomes will depend on a multitude of factors
                      and cannot be determined in advance of the end of the
                      investment period. Historical performance is not entirely
                ...
                <div className="col-lg-4">
                  <div className="login-box">
                    <div className="dark-box">
                      <div className="flx">
                        <h2>
                          ₦{numberWithCommas(details.investment_available)}
                        </h2>
                        <p>AVAILABLE</p>
                      </div>
                    ...
                    <div className="light-box">
                      <p>
                        {details.investors_count} Investor
                        {details.investors_count > 1 && "s"}
                      </p>
                      <p>{Math.round(getPercentLeft())}% Funded</p>
                    </div>
                    <div className="progress-b">
                      <div
                        style={{
                          width: `${Math.round(getPercentLeft())}%`,
                        }}
                        className="line"
                      ></div>
                    </div>
                    <div className="claimed">
                      <p>
                        ₦{formatCurrency(details.discount_claimed)}{" "}
                        {`(${Math.floor(
                    ...
                    <div className="own-fraction">
                      <button onClick={checkoutHandler}>
                        <img src={OwnFractionImg} alt="Own Fraction" />
                      </button>
                    </div>
                  </div>
                </div>
