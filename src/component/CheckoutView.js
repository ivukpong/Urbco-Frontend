      ...
      <div className="form pb-5">
        ...
        >
          ...
          {propertyDetail && propertyDetail.status === "design" && (
            <>
              <option value="opbp">Offline Purchase Bullet Payment</option>
              <option value="optp">Off-plan Purchase Tranche Payment</option>
            </>
          )}
          {propertyDetail && propertyDetail.status === "construction" && (
        ...
        {plan === "optp" && (
          <>
            ...
            >
              ...
              {propertyDetail.optp.percent.split(",").map((o, i) => (
        ...
        <div className="text-center button mt-5" onClick={initiatePayment}>
